...
def calculate_interest():
    ...
    message=Label(result_frame,text="Interest on Rs."+str(p)+" at rate of interest "+str(r)+"% for "+str(t)+" years is Rs."+str(interest), bg = "lightcyan", font=("Calibri", 12), width=55)
...
time_label=Label(window, text="Time in Years", fg = "black", bg = "lightcyan", font=("Calibri", 12))
...
result=Label(result_frame,text="Your result will be displayed here", bg = "lightcyan", font=("Calibri", 12), width=55)
